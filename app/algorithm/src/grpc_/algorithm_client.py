...
class AlgorithmClient:
    """Клиент для отправки сообщений по gRPC"""
    ...
    async def stream(self, task_id: int, async_iter):
        """Передать генератор, который yield-ит элементы для GraphPartResponse"""
